...
def sourceRepository : String := "20th-century-mathematics-theorem-canonical-lane"
def sourceDescription : String := "Canonical lane for 20th century mathematics theorems"
def sourceTheoremBoundary : String := "classical boundary"
def baselineCertificateLane : String := "canonical_lane"
...
def ManifoldConstrainedTheoremClosed : Prop :=
  baselineCertificateLane = "canonical_lane" ∧
